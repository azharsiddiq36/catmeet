        ...
        <article class="col-sm-9">
            <div class="dark data-block">
                ...
                <section>
                    ...
                    <form role="form" action="<?= base_url('administrator/jeniskontes/edit/'.$row['jenis_kontes_id']) ?>" method="post">
                        <div class="form-group row">
                            <label class="col-lg-12">Nama</label>
                            <div class="col-lg-8">
                                <input required type="text" name="nama" value="<?= $row['jenis_kontes_nama']?>" class="form-control"
